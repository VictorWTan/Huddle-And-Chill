    ...
    <div className='flex flex-col'>
      ...
      <div className="mt-6 flex flex-col" onSubmit={handleSubmit}>
          <form className="flex flex-col" autoComplete="off" >
            <input className="m-2 px-5 py-2 border border-gray-600 rounded-lg w-1/3 self-center text-black" placeholder="Email" type="text" name="email" value={credentials.email} onChange={handleChange} required />
            <input className="m-2 px-5 py-2 border border-gray-600 rounded-lg w-1/3 self-center text-black" placeholder="Password" type="password" name="password" value={credentials.password} onChange={handleChange} required />
      ...
      <p className="text-black justify-center self-center">&nbsp;{error}</p>
    </div>
  );
}