        ...
        <div className='flex flex-col border border-black rounded'>
            ...
            <div className="flex flex-row justify-center self-center w-full m-auto">
                ...
                <form className="flex flex-col justify-center self-center" onSubmit={handleSubmit}>
                    <textarea className="flex flex-col justify-center self-center border border-black rounded resize-none" name="status-post" value={content} onChange={handleChange} cols="50" rows="3"></textarea>
                    <input className="my-5 px-5 border border-black rounded w-1/6 self-end" type="submit" value="Post" />
                </form>
            </div>
        </div>
    )
